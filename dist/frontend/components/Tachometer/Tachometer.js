...
const Tachometer = ({ rpm, maxRpm }) => {
    ...
    return (React.createElement(TachometerView, { needleAngle: needleAngle, outerRadius: outerRadius, innerRadius: innerRadius, segments: segments, centerX: centerX, centerY: centerY, redArc: redArc }));
};

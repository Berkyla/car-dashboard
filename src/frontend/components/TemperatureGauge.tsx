...
const TemperatureGauge: React.FC<TemperatureGaugeProps> = ({
  ...
  return (
    <svg width={width} height={height}>
      ...
      {/* Стрелка температуры (треугольная) */}
      <polygon
        points={`${tipX},${tipY} ${baseLeftX},${baseLeftY} ${baseRightX},${baseRightY}`}
        fill="#FF0000"
      />

      {/* Метки температуры (видимые от -4π/3 до -2π/3) */}
      ...
      {/* Невидимые тонкие метки (между видимыми, от -4π/3 до -2π/3) */}
